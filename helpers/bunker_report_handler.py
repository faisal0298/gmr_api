...
def demonstrt_table_report(fetchBunkerdata):
    try:
        ...
        for single_data in fetchBunkerdata:
            ...
            per_data += f"<td class='column2 style21 s' style='text-align: center; border: 1px dotted black; vertical-align: middle; color: #000000; font-family: Calibri; font-size: 12px;background-color: #FFFFFF; border-bottom: 1px solid #000000 !important; border-top: 1px solid #000000 !important; border-left: 1px solid #000000 !important; border-right: 1px solid #000000 !important;'>{single_data.sample_date.strftime('%d.%m.%Y')}</td>"
            ...
            per_data += f"<td class='column4 style7 n' style='text-align: center;border: 1px dotted black;vertical-align: middle;color: #000000;font-family: Calibri;font-size: 12px;background-color: #FFFFFF;border-bottom: 1px solid #000000 !important;border-top: 1px solid #000000 !important;border-left: 1px solid #000000 !important;border-right: 1px solid #000000 !important;'>{round(int(float(single_data.bunkered_qty)), 2)}</td>"
...
def demonstrate_table_bunker(fetchBunkerSingleData):
    try:
        ...
        per_data += f"<td class='column2 style21 s' style='text-align: center; border: 1px dotted black; vertical-align: middle; color: #000000; font-family: Calibri; font-size: 12px;background-color: #FFFFFF; border-bottom: 1px solid #000000 !important; border-top: 1px solid #000000 !important; border-left: 1px solid #000000 !important; border-right: 1px solid #000000 !important;'>{fetchBunkerSingleData.sample_date.strftime('%d.%m.%Y')}</td>"
        ...
        per_data += f"<td class='column4 style7 n' style='text-align: center;border: 1px dotted black;vertical-align: middle;color: #000000;font-family: Calibri;font-size: 12px;background-color: #FFFFFF;border-bottom: 1px solid #000000 !important;border-top: 1px solid #000000 !important;border-left: 1px solid #000000 !important;border-right: 1px solid #000000 !important;'>{round(int(float(fetchBunkerSingleData.bunkered_qty)), 2)}</td>"
        ...
        if "adb_im" in fetchBunkerSingleData:
            per_data += f"<td class='column8 style8 n' style='text-align: center; border: 1px dotted black; vertical-align: middle; color: #000000; font-family: Calibri; font-size: 12px; background-color: #FFFFFF; border-bottom: 1px solid #000000 !important; border-top: 1px solid #000000 !important; border-left: 1px solid #000000 !important; border-right: 1px solid #000000 !important;'>{round(int(float(fetchBunkerSingleData.adb_im)), 2)}</td>"
        if "adb_ash" in fetchBunkerSingleData:
            per_data += f"<td class='column9 style8 n' style='text-align: center; border: 1px dotted black; vertical-align: middle; color: #000000; font-family: Calibri; font-size: 12px; background-color: #FFFFFF; border-bottom: 1px solid #000000 !important; border-top: 1px solid #000000 !important; border-left: 1px solid #000000 !important; border-right: 1px solid #000000 !important;'>{round(int(float(fetchBunkerSingleData.adb_ash)), 2)}</td>"
        if "adb_vm" in fetchBunkerSingleData:
            per_data += f"<td class='column10 style21 n' style='text-align: center; border: 1px dotted black; vertical-align: middle; color: #000000; font-family: Calibri; font-size: 12px; background-color: #FFFFFF; border-bottom: 1px solid #000000 !important; border-top: 1px solid #000000 !important; border-left: 1px solid #000000 !important; border-right: 1px solid #000000 !important;'>{round(int(float(fetchBunkerSingleData.adb_vm)), 2)}</td>"
        if "adb_gcv" in fetchBunkerSingleData:
            per_data += f"<td class='column11 style21 n' style='text-align: center; border: 1px dotted black; vertical-align: middle; color: #000000;font-family: Calibri; font-size: 12px;background-color: #FFFFFF; border-bottom: 1px solid #000000 !important; border-top: 1px solid #000000 !important; border-left: 1px solid #000000 !important; border-right: 1px solid #000000 !important;'>{round(int(float(fetchBunkerSingleData.adb_gcv)), 2)}</td>"
        if "arb_tm" in fetchBunkerSingleData:
            per_data += f"<td class='column12 style21 n' style='text-align: center; border: 1px dotted black; vertical-align: middle; color: #000000; font-family: Calibri; font-size: 12px; background-color: #FFFFFF; border-bottom: 1px solid #000000 !important; border-top: 1px solid #000000 !important; border-left: 1px solid #000000 !important; border-right: 1px solid #000000 !important;'>{round(int(float(fetchBunkerSingleData.arb_tm)), 2)}</td>"
        if "arb_vm" in fetchBunkerSingleData:
            per_data += f"<td class='column13 style21 n' style='text-align: center; border: 1px dotted black; vertical-align: middle; color: #000000; font-family: Calibri; font-size: 12px; background-color: #FFFFFF; border-bottom: 1px solid #000000 !important; border-top: 1px solid #000000 !important; border-left: 1px solid #000000 !important; border-right: 1px solid #000000 !important;'>{round(int(float(fetchBunkerSingleData.arb_vm)), 2)}</td>"
        if "arb_ash" in fetchBunkerSingleData:
            per_data += f"<td class='column14 style21 n' style='text-align: center; border: 1px dotted black; vertical-align: middle; color: #000000; font-family: Calibri; font-size: 12px; background-color: #FFFFFF; border-bottom: 1px solid #000000 !important; border-top: 1px solid #000000 !important; border-left: 1px solid #000000 !important; border-right: 1px solid #000000 !important;'>{round(int(float(fetchBunkerSingleData.arb_ash)), 2)}</td>"
        if "arb_fc" in fetchBunkerSingleData:
            per_data += f"<td class='column15 style21 n' style='text-align: center; border: 1px dotted black; vertical-align: middle; color: #000000; font-family: Calibri; font-size: 12px; background-color: #FFFFFF; border-bottom: 1px solid #000000 !important; border-top: 1px solid #000000 !important; border-left: 1px solid #000000 !important; border-right: 1px solid #000000 !important;'>{round(int(float(fetchBunkerSingleData.arb_fc)), 2)}</td>"
        if "arb_gcv" in fetchBunkerSingleData:
            per_data += f"<td class='column16 style21 n' style='text-align: center; border: 1px dotted black; vertical-align: middle; color: #000000; font-family: Calibri; font-size: 12px; background-color: #FFFFFF; border-bottom: 1px solid #000000 !important; border-top: 1px solid #000000 !important; border-left: 1px solid #000000 !important; border-right: 1px solid #000000 !important;'>{round(int(float(fetchBunkerSingleData.arb_gcv)), 2)}</td>"
        ...
        <body>
            <table cellpadding="0" cellspacing="0" id="sheet0" class="sheet0 gridlines" style="width: 100% !important; border-collapse:collapse; page-break-after:always;">
                ...
                <tr class="row5" style="height:15px;">
                    <td class="column1 style69 s style71" colspan="7" style="border: 1px dotted black;text-align: left;vertical-align: top;padding-left: 0px;border-right: 1px solid #000000 !important;font-weight: bold;color: #000000;font-family: 'Calibri';font-size: 12px;background-color: #FFFFFF;border-left: 2px solid #000000 !important;border-bottom: 1px solid #000000 !important;border-top: 1px solid #000000 !important;">ULR : {fetchBunkerSingleData.ulr}<br></td>
                ...
                <tr class="row6" style="height:15px;">
                    <td class="column1 style85 s style86" colspan="4" style="border: 1px dotted black;text-align: left;vertical-align: middle;padding-left: 0px;font-weight: bold;color: #000000;font-family: 'Calibri';font-size: 12px;background-color: #FFFFFF;border-bottom: 1px solid #000000 !important;border-top: 1px solid #000000 !important;border-left: 1px solid #000000 !important;border-right: 1px solid #000000 !important;">Certificate no: {fetchBunkerSingleData.certificate_no}</td>
